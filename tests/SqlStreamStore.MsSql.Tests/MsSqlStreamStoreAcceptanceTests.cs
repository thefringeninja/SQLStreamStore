...
public class MsSqlStreamStoreAcceptanceTests(
	MsSqlStreamStoreFixturePool fixturePool,
	ITestOutputHelper testOutputHelper)
	: AcceptanceTests(testOutputHelper), IClassFixture<MsSqlStreamStoreFixturePool> {
    ...
    public async Task Time_taken_to_append_and_read_large_message_with_prefetch()
    {
        ...
        Logger.LogInformation($"Append: {stopwatch.Elapsed}");
        ...
        Logger.LogInformation($"Read: {stopwatch.Elapsed}");
    }
