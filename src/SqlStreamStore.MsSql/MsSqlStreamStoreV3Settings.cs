...
public class MsSqlStreamStoreV3Settings {
	...
	public MsSqlStreamStoreV3Settings(string connectionString, ILoggerFactory? loggerFactory = null) {
		ArgumentException.ThrowIfNullOrWhiteSpace(connectionString);

		CreateStreamStoreNotifier = store => new PollingStreamStoreNotifier(store, loggerFactory?
			.CreateLogger<MsSqlStreamStoreV3>());
