...
internal sealed class JsonHttpClient : IJsonHttpClient {
	...
	public JsonHttpClient(Func<HttpClient> clientFactory, JsonSerializerOptions serializerOptions, Uri baseAddress) {
	...
	public async Task<HttpResponseMessage> PostAsync<T>(
		...
		using var request = new HttpRequestMessage(HttpMethod.Post, uri) {
			Content = JsonContent.Create(value, options: _serializerOptions)
		};
